...
urlpatterns = [
    ...
    path('adminUserEdit/<int:pk>', views.adminUserEdit, name = "adminUserEdit"),
    path('adminProjectEdit/<int:pk>/', views.adminProjectEdit, name = "adminProjectEdit"),
    path('members/<int:pk>/', views.adminProjectMembers, name = "adminProjectMembers"),
    ...
    path('projects/<int:pk>/report/',views.report, name = "report"),
    path('projects/<int:pk>/projDetails/',views.projDetails, name = "projDetails"),
    path('projects/<int:pk>/functionalities/',views.functionalities, name = "functionalities"),
    ...
    path('projects/<int:pk>/areportedBug/',views.areportedBug, name = "areportedBug"),
    ...
    path('reviewpof/',views.reviewpof, name = "reviewpof"),
    path('reviewbugpof/',views.reviewbugpof, name = "reviewbugpof"),
